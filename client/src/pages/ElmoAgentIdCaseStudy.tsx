...
const ElmoAgentIdCaseStudy = () => {
  const elmoAgentIdData = {
    ...
    solution: "We deployed a comprehensive 6-category assessment framework evaluating processes across Volume & Frequency, Process Standardisation, Employee Experience, Time Investment, plus Strategic Alignment and ROI Measurability. This framework enabled ELMO to systematically score potential use cases from different parts of the business, empowering them to choose the highest-impact opportunity that aligned with both technical feasibility and business priorities.",
    implementation: "Strategic Selection and Measurable Success",
    results: [
      ...
      "This strategic framework led ELMO to select Sales Development Representative prospect research as their first use case—a decision that resulted in saving each team member nearly 12 working days per year on research tasks"
    ],
    ctaLink: {
      text: "See the NALAH use case here →",
